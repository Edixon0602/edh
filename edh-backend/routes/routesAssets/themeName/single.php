  ...
  <!-- #page -->
    ...
    <div id="page-content">
      ...
      ?>
        ...
        <div class="row position-relative <?php echo esc_attr( $width . ' ' . $section['columns_horizontal_alignment'] . ' ' . $section['columns_vertical_alignment'] ) ?>">
              <?php 
